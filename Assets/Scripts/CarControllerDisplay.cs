...
public class CarControllerDisplay : MonoBehaviour {
    ...
    private Text timerText; //work on
    private Text HpText; //work on

    private float hpValue = 200f;
    ...
    void Start()
    {
        ...
        myHpString = CarOptions.HpTextName;
    ...
    void HUD()
    {
        ...
        HpText = GameObject.Find(myHpString).GetComponent<Text>();
